      ...
      <div className="relative max-w-7xl mx-auto">
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <StatCard
            ...
            number="The Vision"
            label="Using AI, we make communication training accessible"
          />
          ...
          <StatCard
            ...
            number="Find Your Voice"
            label="Everyone deserves to speak with clarity and confidence
"
          />
          ...
          <StatCard
            ...
            number="Talk With AI"
            label="Engage in real conversations with Sparrow’s intelligent assistant"
          />
...
"
            label="Sparrow empowers you to express yourself freely"
          />
        </div>
      </div>
