    ...
    <div className="w-full">
      ...
      >
        <div className="p-6">
          ...
          <div className="bg-pink-50 rounded-xl p-6 shadow-md border border-pink-100">
            <div className="flex items-start justify-between mb-3">
              <h3 className="text-xl font-bold text-gray-800 flex-1">
                {title}
              </h3>
              <div className="flex items-center gap-1 text-sm text-gray-600 bg-white px-2 py-1 rounded-full ml-2">
