...
import { Clock, ExternalLink, Play, Pause, X, BarChart3, Tag, MessageSquare } from 'lucide-react';
...
const TongueTwisters: React.FC = () => {
  ...
  const duration = 10; // seconds (4 minutes = 240 seconds in production)
  const exerciseId = 'tongue-twisters';
  const title = 'Tongue Twisters';
  const description = 'Practice specific tongue twisters slowly then speed up';
    ...
    <div className="w-full">
      ...
      >
        ...
        <div className="flex flex-col items-center max-w-2xl mx-auto space-y-6">
          {/* 1. The Animated Graphic (Hero Element) - Speech Bubble with Pulse */}
          <div className="flex items-center justify-center py-8">
            ...
            >
              <MessageSquare className="w-32 h-32 text-white/80 stroke-[1.5]" />
            </motion.div>
          </div>
