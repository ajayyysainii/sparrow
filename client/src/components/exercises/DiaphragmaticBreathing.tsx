...
const DiaphragmaticBreathing: React.FC = () => {
  const {
    stats,
    loading,
    toast,
  ...
  const duration = 10; // seconds (changed by user)
  const exerciseId = 'diaphragmatic';
  const title = 'Diaphragmatic Breathing';
  const description = 'Lie down, place hand on belly, breathe deeply';
    ...
    <div className="w-full">
      ...
      >
        ...
        <div className="flex flex-col items-center max-w-2xl mx-auto space-y-6">
          {/* 1. The Animated Graphic (Hero Element) */}
            ...
            <div className="relative w-64 h-64 flex items-center justify-center">
              <motion.div
                ...
                transition={{
                  duration: 6,
                  repeat: Infinity,
                  ease: [0.4, 0, 0.6, 1], // Custom easing for natural breath
                }}
                style={{
                  width: 200,
                  height: 200,
